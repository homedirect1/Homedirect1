 ...
 * CedCommerce
  ...
  */
namespace Ced\OrderDelete\Model;
...
class Feed extends \Magento\AdminNotification\Model\Feed
{
    ...
    public function checkUpdate()
    {
        ...
        $feedXml = $this->getFeedData($this->_objectManager->get('Ced\OrderDelete\Helper\Feed')->getEnvironmentInformation());
        //print_r($feedXml);
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
            ...
            $installedModules=$this->_objectManager->get('Ced\OrderDelete\Helper\Feed')->getCedCommerceExtensions();
            foreach ($feedXml->channel->item as $item) {
                
                if(!isset($installedModules[(string)$item->module])) {
                    continue;
                }
                if($this->_objectManager->get('Ced\OrderDelete\Helper\Feed')->isAllowedFeedType($item)) {
