...
class Config extends \Magento\Framework\DataObject
{
     ...
     * @param string $path
     */
    public function getCurrentStoreConfigValue(string $path)
    {
        return $this->_scopeConfig->getValue($path, 'store', $this->_storeCode);

    }//end getCurrentStoreConfigValue()
     ...
     * @param string $value
     */
    public function setCurrentStoreConfigValue(string $path, string $value)
    {
        $data = [
            'path'       => $path,
            'scope'      => 'stores',
    ...
    }//end setCurrentStoreConfigValue()
