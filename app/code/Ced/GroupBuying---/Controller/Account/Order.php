...
class Order extends Action
{
    ...
    private ProductRepositoryInterface $productRep;
    private CartRepositoryInterface $cartRep;
    private SessionFactory $checkoutSession;
    private CustomerFactory $customerFactory;
    private CollectionFactory $_giftCollectionFactory;
    private \Ced\GroupBuying\Model\ResourceModel\Main\CollectionFactory $_lastCollectionFactory;
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($this->sessionFactory->create()->getUseNotice(true)) {
