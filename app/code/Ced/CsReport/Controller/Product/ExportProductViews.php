...
/**
 * Class ExportProductViews
 * @package Ced\CsReport\Controller\Product
 */
class ExportProductViews extends \Ced\CsMarketplace\Controller\Vendor
{
    /**
    ...
    /**
     * ExportProductViews constructor.
    ...
    public function execute()
    {
        ...
        $gridBlock = $this->_view->getLayout()->createBlock(
            'Ced\CsReport\Block\Product\Views\Grid'
        );
