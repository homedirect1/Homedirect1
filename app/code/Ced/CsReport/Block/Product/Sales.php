...
class Sales extends \Magento\Backend\Block\Widget\Grid\Container
{
	...
	protected function _construct()
    {
        ...
        $this->_controller = 'product_sales';
        $this->_blockGroup = 'Ced_CsReport';
        $this->_headerText =  'Product(s) Sales Report';
        parent::_construct();
    ...
    public function getFilterActionUrl(){
        return $this->getUrl("csreport/product/sales", ["_use_rewrite" => true]);
    }

    public function getExportCsvAction(){
        return $this->getUrl("csreport/product/exportSalesReport", ["_use_rewrite" => true]);
    }
}