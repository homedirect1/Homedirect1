 ...
 */
class ExportOrderdesc extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
                    ...
                    if ($incrementId == 'order_id') {
                        ...
                        if (is_array($baseNetAmount)) {
                            ...
                            if ($area != 'adminhtml' && $vorder && $vorder->getId()) {
                                ...
                                $html .= "Order # " . $orderIncrementId  . " Net Earned " . $amount . "\n";
                            } else {
                                $html .= "Order # " . $orderIncrementId  . " Amount " . $amount . "\n";
                            }
                            return $html;
                        }
                    } else {
