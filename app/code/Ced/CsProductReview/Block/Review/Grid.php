...
/**
 * Class Grid
 * @package Ced\CsProductReview\Block\Review
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Ced\CsProductReview\Model\ReviewFactory
     */
    protected $csproductReviewFactory;

    /**
     * Grid constructor.
     * @param \Ced\CsProductReview\Model\ReviewFactory $csproductReviewFactory
    ...
    public function __construct(
        \Ced\CsProductReview\Model\ReviewFactory $csproductReviewFactory,
    ...
    )
    {
        ...
        $this->csproductReviewFactory = $csproductReviewFactory;
    ...
    protected function _prepareCollection()
    {
        ...
        $vproductIds = $this->csproductReviewFactory->create()->getVendorProductIds($vendorId);
