...
/**
 * Class License
 * @package Ced\StorePickup\Controller\Adminhtml\Main
 */
class License extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Ced\StorePickup\Helper\Feed|null
     */
     ...
     * @param \Ced\StorePickup\Helper\Feed $_feedHelper
     */
    public function __construct(
        Context $context,
        \Ced\StorePickup\Helper\Feed $_feedHelper
    )
    {
    ...
    private function getLicenseActivateUrl()
    {
        if (is_null($this->_licenseActivateUrl)) {
            $this->_licenseActivateUrl = ($this->_feedHelper->getStoreConfig(\Ced\StorePickup\Block\Extensions::LICENSE_USE_HTTPS_PATH) ? 'https://' : 'http://')
