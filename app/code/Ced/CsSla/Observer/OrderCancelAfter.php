...
namespace Ced\CsSla\Observer;

use Magento\Framework\Event\ObserverInterface;

/**
 * Class OrderCancelAfter
 * @package Ced\CsSla\Observer
 */
Class OrderCancelAfter implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        try {
            ...
            if (count($vorders) > 0) {
                ...
                $this->mailHelper->sendOrderEmail($order, \Ced\CsMarketplace\Model\Vorders::ORDER_CANCEL_STATUS);
            }
            return $this;
    ...
    public function cancelCase($id, $incrementId, $vendorId)
    {
        ...
        $totalFee = 0;
        foreach ($fees as $fee) {
            if ($fee->getFieldCode() == "sla_auto_cancel_fee") {
                continue;
            }
