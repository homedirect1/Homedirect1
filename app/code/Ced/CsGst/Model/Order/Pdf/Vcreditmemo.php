...
class Vcreditmemo extends \Ced\CsOrder\Model\Order\Pdf\Creditmemo
{
    ...
    public function getPdf($creditmemos = [])
    {
        ...
        foreach ($creditmemos as $creditmemo) {
            ...
            $this->insertDocumentNumber($page, __('Credit Memo # ') . $creditmemo->getIncrementId().'  GSTIN: '.$this->vendorFactory->create()->load($vendorId)->getVendorGstin());
            /* Add table head */
