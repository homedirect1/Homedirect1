 ...
 */
class Tabs extends /*\Magento\CatalogRule\Block\Adminhtml\Promo\Catalog\Edit\Tabs*/\Magento\Backend\Block\Widget\Tabs
{
    ...
    protected function _construct()
    {
        ...
        $this->setDestElementId('catalog_rule_view');
