...
namespace Ced\CsPromotions\Block\Adminhtml\Promo\Quote\Edit\Tab\Coupons;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            [
                'label' => __('Delete'),
                'url' => $this->getUrl('cspromotions/*/couponsMassDelete', ['_current' => true]),
    ...
    {
        return $this->getUrl('cspromotions/*/couponsGrid', ['_current' => true]);
    }
}
