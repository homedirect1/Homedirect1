...
namespace Ced\CsPromotions\Block\Promo\Quote;

use Magento\Customer\Model\Session;

/**
 * Class Grid
 * @package Ced\CsPromotions\Block\Promo\Quote
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('vendorsalesrulegrid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('approve', [
                ...
                'filter' => false,
                'type' => 'text',
                'renderer' => 'Ced\CsPromotions\Block\Promo\Quote\Renderer\Approved',
            ]
        );
