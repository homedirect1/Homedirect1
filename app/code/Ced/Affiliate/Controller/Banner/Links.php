...
namespace Ced\Affiliate\Controller\Banner;

/**
 * Class Links
 * @package Ced\Affiliate\Controller\Banner
 */
class Links extends \Ced\Affiliate\Controller\Affiliate
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Banners And Links'));
        $resultPage->getConfig()->getTitle()->prepend(__('Banners And Links'));
        return $resultPage;
    }
}
