...
namespace Ced\Affiliate\Controller\Payout;

/**
 * Class Save
 * @package Ced\Affiliate\Controller\Payout
 */
class Save extends \Magento\Framework\App\Action\Action
{
     ...
     */
    protected $discountDenominationCollectionFactory;
     ...
     * @param \Ced\Affiliate\Model\ResourceModel\DiscountDenomination\CollectionFactory $discountDenominationCollectionFactory
    ...
    public function __construct(
        ...
        \Ced\Affiliate\Model\ResourceModel\DiscountDenomination\CollectionFactory $discountDenominationCollectionFactory,
    ...
    {
        $this->discountDenominationCollectionFactory = $discountDenominationCollectionFactory;
    ...
    public function execute()
    {
        ...
        if ($amount > $available) {
            ...
            $this->_redirect('affiliate/referral/payout');
            return;
        }
        ...
        $minpurchase = 0;
        $cart_amount_check_rule = $this->discountDenominationCollectionFactory->create()
        ...
        $customerGroups = $this->customerGroup->getCollection();
        $groups = array();
