...
class Approve extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $model->setStatus(\Ced\Affiliate\Model\AffiliateAccount::APPROVE);
        $model->setApprove(\Ced\Affiliate\Model\AffiliateAccount::APPROVE);
        $model->save();
        $this->emailHelper->sendConfirmationEmail($model, \Ced\Affiliate\Model\AffiliateAccount::APPROVE);
        $this->emailHelper->sendAdminNotifyStatusMail($model, \Ced\Affiliate\Model\AffiliateAccount::APPROVE);
        $this->messageManager->addSuccessMessage(__('Account Has Been Approved'));
