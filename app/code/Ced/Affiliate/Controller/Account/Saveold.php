...
class Save extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($isApprovalRequired) {
            $this->messageManager->addSuccessMessage(__('Thank you for registering with %1. Your Account Is Under Admin Approval.On Approval You Will Recieve an Email', $this->storeManager->getStore()->getFrontendName()));
