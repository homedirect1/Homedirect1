 ...
 */
class RequiredFields extends \Magento\Framework\Model\AbstractModel
{
    /**
    ...
    {
        $terms = $this->affiliateHelper->getTermsAndCondition();
        $affiliateData = [];
        if ($terms) {
            $affiliate['enable'] = true;
            $affiliate['terms-condition'] = $terms;
        } else {
            $affiliate['enable'] = false;
        }

        $affiliateData['termsandcondition'] = $affiliate;
