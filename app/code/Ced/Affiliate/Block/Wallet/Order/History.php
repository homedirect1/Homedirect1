...
namespace Ced\Affiliate\Block\Wallet\Order;
...
class History extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ced_Affiliate::wallet/order/history.phtml';
    ...
    {
        parent::_construct();
        $this->pageConfig->getTitle()->set(__('Wallet Orders'));
    }
    ...
    {
        return $this->getUrl('affiliate/wallet/orderview', ['order_id' => $order->getId()]);
    }
