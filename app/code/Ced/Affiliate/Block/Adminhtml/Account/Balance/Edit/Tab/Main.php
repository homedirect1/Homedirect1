...
namespace Ced\Affiliate\Block\Adminhtml\Account\Balance\Edit\Tab;

/**
 * Class Main
 * @package Ced\Affiliate\Block\Adminhtml\Account\Balance\Edit\Tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        parent::_prepareForm();
        $podata = $this->_coreRegistry->registry('current_account_data');
        ...
        $fieldset->addField(
            ...
            [
                ...
                'values' => $this->paymentMethodsFactory->create()->getPaymentMethodsArray($podata['customer_id']),
                'class' => '',
                'required' => true,
            ]
        );
