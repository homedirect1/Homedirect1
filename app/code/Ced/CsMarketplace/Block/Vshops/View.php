...
class View extends Template
{
    ...
    {
        $blockObject= $this->getLayout()->createBlock('Ced\CsMarketplace\Block\Vshops\Catalog\Product\ListProduct');
        return $blockObject->getRequest()->getParam(ListProduct::SEARCH_QUERY_PARAM, '');
    }
}
