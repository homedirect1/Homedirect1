...
namespace Ced\CsAdvTransaction\Block\Adminhtml\Payments\Details;

/**
 * Class Form
 * @package Ced\CsAdvTransaction\Block\Adminhtml\Payments\Details
 */
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    {
        $model = $this->_coreRegistry->registry('csadvtransaction_current_transaction');
