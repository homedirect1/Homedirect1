...
class OneSix extends \Magento\Framework\App\Helper\AbstractHelper
{
...
//            "newproducts" => $this->getNewArrivals(),
            ...
            "spin_win_response" => [
                    "maximum_display_frequency" => "0",
                    "wheel_display_interval" => "5",
                    "is_spin_and_win_enabled" => false
                ],
            ...
            "title_bar_logo_url" => (isset($logo_settings["image"])) ?  $this->dataHelper->getMediaUrl()."/Knowband_Mobileappbuilder/".$logo_settings["image"] : "",
            ...
            if (!empty($components)) {
                ...
                foreach ($components as $key => $comp) {
                    ...
                    if ($component_type == 'top_category') {
                        ...
                        $response[$i]['heading'] = $banner_heading;
                        $response[$i]['data'] = [];
                        ...
                        if (!empty($products)) {
                            ...
                            $response[$i]['heading'] = isset($components[$i]['component_heading']) ? $components[$i]['component_heading'] : "";
