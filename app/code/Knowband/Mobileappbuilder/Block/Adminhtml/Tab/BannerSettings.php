...
class BannerSettings extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    private $sp_helper;
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter( 'type', 'banner' );
    ...
    public function getGridUrl() {
        return $this->getUrl('*/*/bannerAjax', ['_current' => true]);
    }
    
    public function getTabLabel()
    {
        return __('Banners Settings');
    }
