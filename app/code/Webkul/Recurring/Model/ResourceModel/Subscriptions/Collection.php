 ...
 */
namespace Webkul\Recurring\Model\ResourceModel\Subscriptions;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\Recurring\Model\Subscriptions::class,
            \Webkul\Recurring\Model\ResourceModel\Subscriptions::class
        );
